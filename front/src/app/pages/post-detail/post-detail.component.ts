...
export class PostDetailComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.mapsUrl = this.sanitizer.bypassSecurityTrustResourceUrl(`https://www.google.com/maps/embed/v1/view?key=${MAPS_API_KEY}&center=${this.authorData.address.geo.lat},${this.authorData.address.geo.lng}&zoom=13`)
